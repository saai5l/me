...
const BOOT = [
  ...
  '> cache: loading user assets...',
  '> api: fetching user manifest...',
  '> api: resolving guild data...',
  '> api: syncing permissions...',
  '> db: connecting to user database...',
  '> db: validating records...',
  '> renderer: building store grid...',
  '> renderer: injecting components...',
  '> ui: applying glass pipeline...',
  '> ui: loading animations...',
  '> ui: binding interactions...',
  '> security: verifying session...',
  '> security: token accepted.',
  '> visitor: counter initialized.',
  '> visitor: tracking enabled.',
  '> theme: preference restored.',
  '> theme: applying colors...',
  '> system: finalizing boot...',
  '[✓] system ready.',
];
